...
async def create_temp_file(content: str, extension: str) -> str:
    ...
    #temp_dir = "/home/transwarp/Documents/workspace/private/LLM_reasoning_framework/MCP/mindmap-mcp-server/"
    file_path = os.path.join(temp_dir, f"input{extension}")
    
    with open(file_path, mode='w') as f:
        f.write(content)
    
    # Set permissions for the temporary file and directory
...
async def run_mindmap(input_file: str, output_file: str = None) -> str:
    ...
    if output_file:
        ...
        #output_file = "/home/transwarp/Documents/workspace/private/LLM_reasoning_framework/MCP/mindmap-mcp-server/input.html"
