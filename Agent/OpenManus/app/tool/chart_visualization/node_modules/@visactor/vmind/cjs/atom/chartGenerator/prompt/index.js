...
const patchUserInput = userInput => {
    ...
    finalStr;
}, revisedUserInput = (query, vizSchema) => {
    const userInput = patchUserInput(query), filteredFields = vizSchema.fields.filter((field => field.visible)).map((field => Object.assign({}, (0, 
    vutils_1.pick)(field, [ "id", "description", "type", "role" ]))));
...
exports.revisedUserInput = revisedUserInput;
