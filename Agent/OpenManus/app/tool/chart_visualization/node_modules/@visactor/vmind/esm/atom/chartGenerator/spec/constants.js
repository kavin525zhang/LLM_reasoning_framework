...
export const LINEAR_COLOR_THEMES = [ [ "#1DD0F3", "#73EC55" ], [ "#2693FF", "#F6FB17" ], [ "#3259F4", "#FBBB16" ], [ "#1B0CA1", "#FF581D" ], [ "#1DD0F3", "#CB2BC6" ] ];
...
export const DEFAULT_VIDEO_LENGTH = 2e3;

export const DEFAULT_PIE_VIDEO_LENGTH = 5e3;

export const DEFAULT_VIDEO_LENGTH_LONG = 1e4;

export const VIDEO_LENGTH_BY_CHART_TYPE = {
    pie: 5e3,
    wordCloud: 1e4,
    wordcloud: 1e4
};
