...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports._chatToVideoWasm = void 0;

const vutils_1 = require("@visactor/vutils");

let idx = 0;

function _chatToVideoWasm(fps, propsSpec, propsTime, outName = "out", outerPackages, mode) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, (function*() {
        ...
        idx++;
        const defaultTicker = new ManualTicker, spec = (0, vutils_1.cloneDeep)(propsSpec), time = (0, 
        vutils_1.cloneDeep)(propsTime), {totalTime: totalTime, frameArr: frameArr} = time, width = null !== (_a = spec.width) && void 0 !== _a ? _a : 720, height = null !== (_b = spec.height) && void 0 !== _b ? _b : 480;
...
exports._chatToVideoWasm = _chatToVideoWasm;
