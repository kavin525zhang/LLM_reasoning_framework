...
const vutils_1 = require("@visactor/vutils"), vrender_core_1 = require("@visactor/vrender-core"), base_1 = require("../core/base"), constant_1 = require("./constant"), register_1 = require("./register");
...
class Slider extends base_1.AbstractComponent {
    ...
    constructor(attributes, options) {
        ...
        this._currentValue = {}, this._onTooltipShow = e => {
            ...
            this._currentHandler = e.target, this._prePos = this._isHorizontal ? x : y, "browser" === vrender_core_1.vglobal.env ? (vrender_core_1.vglobal.addEventListener("pointermove", this._onHandlerPointerMove, {
                capture: !0
            ...
            e.stopPropagation(), this._isChanging = !0;
            const {x: x, y: y} = this.stage.eventPointTransform(e);
            this._prePos = this._isHorizontal ? x : y, "browser" === vrender_core_1.vglobal.env ? (vrender_core_1.vglobal.addEventListener("pointermove", this._onTrackPointerMove, {
                capture: !0
