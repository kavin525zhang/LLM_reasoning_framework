...
const vrender_core_1 = require("@visactor/vrender-core"), vutils_1 = require("@visactor/vutils"), base_1 = require("../core/base"), register_1 = require("./register"), constant_1 = require("../constant"), delayMap = {
    ...
    constructor(attributes, options) {
        ...
        this.name = "scrollbar", this._onRailPointerDown = e => {
            ...
            this._prePos = "horizontal" === direction ? x : y, this._dispatchEvent(constant_1.SCROLLBAR_START_EVENT, {
                pos: this._prePos,
                event: e
            }), "browser" === vrender_core_1.vglobal.env ? (vrender_core_1.vglobal.addEventListener("pointermove", this._onSliderPointerMoveWithDelay, {
                capture: !0
            }), vrender_core_1.vglobal.addEventListener("pointerup", this._onSliderPointerUp)) : (this.stage.addEventListener("pointermove", this._onSliderPointerMoveWithDelay, {
                capture: !0
        ...
        this._onSliderPointerUp = e => {
            ...
            this._dispatchEvent(constant_1.SCROLLBAR_END_EVENT, {
                pre: preRange,
                value: (0, vutils_1.clampRange)(range, limitRange[0], limitRange[1])
            }), "browser" === vrender_core_1.vglobal.env ? (vrender_core_1.vglobal.removeEventListener("pointermove", this._onSliderPointerMoveWithDelay, {
                capture: !0
            }), vrender_core_1.vglobal.removeEventListener("pointerup", this._onSliderPointerUp)) : (this.stage.removeEventListener("pointermove", this._onSliderPointerMoveWithDelay, {
                capture: !0
