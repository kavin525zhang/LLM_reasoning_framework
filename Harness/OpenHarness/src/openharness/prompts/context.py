...
from openharness.log_utils import logger
...
def _build_skills_section(
    ...
    *,
    ...
    logger.info("load_skill_registry cwd:{}, extra_skill_dirs:{}, extra_plugin_roots:{}".format(cwd, 
                                                                                                extra_skill_dirs,
                                                                                                extra_plugin_roots))
...
def build_runtime_system_prompt(
    ...
    *,
    ...
    logger.info("include_project_memory:{}, settings.memory.enabled:{}".format(include_project_memory, settings.memory.enabled))
    if include_project_memory and settings.memory.enabled:
        ...
        # 这里有个记忆的查询
        logger.info("latest_user_prompt:{}".format(latest_user_prompt))
