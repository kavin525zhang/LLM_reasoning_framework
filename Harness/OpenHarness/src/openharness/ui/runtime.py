...
import logging
logging.basicConfig(filename="/home/transwarp/Documents/workspace/private/LLM_reasoning_framework/Harness/OpenHarness/logs/1.log",
                    level=logging.INFO)
log = logging.getLogger(__name__)
log.info("tessssssssssssst")
...
async def handle_line(
    ...
    *,
    ...
    log.info("system_prompt:{}".format(system_prompt))
    bundle.engine.set_system_prompt(system_prompt)
    try:
