...
logging.basicConfig(filename="/home/transwarp/Documents/workspace/private/LLM_reasoning_framework/Harness/OpenHarness/logs/t.log",
                    level=logging.INFO)
...
class ReactBackendHost:
    ...
    async def _process_line(
        ...
        *,
        ...
        log.info("handle_line:{}".format(line))
