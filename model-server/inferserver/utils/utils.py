...
from inferserver.server.embedding_model import EmbeddingModelService, EmbeddingOrtModelService, FlagEmbeddingModelService
...
def init_embedding_model(config: dict, flag=False) -> dict[Any, Any]:
    res = {}
    for model_name, model_config in config.items():
        if not flag:
            ...
            service_class = FlagEmbeddingModelService
        res[model_name] = {
