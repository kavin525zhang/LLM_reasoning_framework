...
function JsonNode({ node, depth, deleteHandle: _deleteHandle, indexOrName, parent, editHandle, parentPath }) {
    ...
    if (Array.isArray(node) || isObject(node)) {
        ...
        const Icons = (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [isEditing &&
                    ...
                    editHandle &&
                    (typeof EditComponent === 'function' ? (jsxRuntime.jsx(EditComponent, { className: 'json-view--edit', onClick: edit })) : (jsxRuntime.jsx(SvgEdit, { className: 'json-view--edit', onClick: edit }))), !isEditing && editableDelete(editable) && customDelete(customReturn) && _deleteHandle && (jsxRuntime.jsx(SvgTrash, { className: 'json-view--edit', onClick: () => setDeleting(true) })), typeof CustomOperation === 'function' ? jsxRuntime.jsx(CustomOperation, { node: node }) : null] }));
